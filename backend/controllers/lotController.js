...
// GET ALL LOTS (non supprimés et libres)
exports.getLotsLibres = async (req, res) => {
  try {
    // Cherche tous les lots non supprimés
    const lots = await Lot.find({ deletedAt: null, statut: "LIBRE" });
